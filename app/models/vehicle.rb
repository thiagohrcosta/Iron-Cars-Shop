class Vehicle < ApplicationRecord
  ...
  has_one  :vehicle_listing,  dependent: :destroy
  ...
  scope :active,              -> { joins(:vehicle_listing).where(veihcle_listings: { status: "published" }) }
  scope :published_on_marketplace, -> { joins(:vehicle_listing).where(veihcle_listings: { status: "published" }) }
